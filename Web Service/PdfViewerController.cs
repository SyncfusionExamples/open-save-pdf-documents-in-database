        ...
        public IActionResult Load([FromBody] Dictionary<string, string> jsonObject)
        {
            ...
            if (jsonObject != null && jsonObject.ContainsKey("document"))
            {
                if (bool.Parse(jsonObject["isFileName"]))
                {
                    ...
                    string query = "SELECT FileData FROM YourTable WHERE FileName = '" + documentName + "'";
...
        public IActionResult Unload([FromBody] Dictionary<string, string> jsonObject)
        ...
        public IActionResult Download([FromBody] Dictionary<string, string> jsonObject)
        {
            ...
            {
                connection.Open();
                // Insert a new record into YourTable to save the downloaded PDF along with data
                using (SqlCommand cmd = new SqlCommand("INSERT INTO YourTable (FileName, fileData) VALUES (@FileName, @fileData)", connection))
                {
